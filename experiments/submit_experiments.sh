...
# Which experiment would you like to run? Experiments in the paper: 2,3,101,102
CONF=2
...
if [[ $CONF == 1 ]]; then
  ...
  CONFIDENCE_LIST=(95)
  METHOD_LIST=("classical" "bayesian-dp-?" "bootstrap" "conformal-constant")
  W_LIST=1000
...
D_LIST=3
SEED_LIST=$(seq 1 10)
POSTERIOR_LIST=("mcmc") # This is not being used
