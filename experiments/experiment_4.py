...
# Output file
outfile_prefix = "exp4_" + sketch_name + "_" + stream_name + "_d" + str(d) + "_w" + str(w) + "_n" + str(n) + "_s" + str(seed) + "_" + posterior + "_shift" + str(shift)
...
# Run experiment
results = worker.run(n, n_test, confidence=confidence, seed=seed, shift=shift)
